                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form role="form" class="user" action="sendEmail" method="post" name="sendEmail">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="exampleInputEmail" name="userEmail" aria-describedby="emailHelp"
                                                placeholder="입력한 이메일로 임시 번호가 전송됩니다.">
                                        </div>
