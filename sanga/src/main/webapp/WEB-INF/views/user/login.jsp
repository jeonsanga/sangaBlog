...
/* 	 $.ajax({
			...
			success: function(data) {
				console.log(data);
				if(data == 1){
					alert("로그인에 성공하였습니다.",data);
				}else if(data == 0){
					alert("비밀번호가 일치하지 않습니다.",data);
				}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="/user/login" id="userForm" class="user" method="post">
                                        ...
                                        <input type="submit" value="전송" class="btn btn-primary btn-user btn-block">
                                        <hr>
                                          
