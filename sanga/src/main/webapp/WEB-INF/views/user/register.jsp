                        ...
                        <div class="p-5">
                            ...
                            <form id="registerForm" class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div  class="col-sm-6">
	                                    <button type="button" onclick="passwordCheck()" class="btn btn-outline-secondary">비밀번호 체크</button><br/>
                                    </div>
                                </div>
                                
                                <a href="/user/login" onclick="registerAccount();" class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </a>
                                <hr>
